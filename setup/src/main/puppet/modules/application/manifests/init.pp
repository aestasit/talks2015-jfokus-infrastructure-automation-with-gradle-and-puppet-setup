...
class application(
  # $app_location = 'https://oss.sonatype.org/content/repositories/snapshots/com/aestasit/workshops/org/springframework/samples/petclinic/0.1-SNAPSHOT/petclinic-0.1-20150201.232449-1.war',
  ...
  $vhost_name        = 'local.petclinic.jfokus.se',
  $db_host           = '', 
